...
def sam3_refiner(
    ...
    Args:
        ...
        margin: CEBox expansion threshold.
        gamma: Gaussian spread for point extraction.
    ...
    for mask_idx in range(coarse_masks.shape[0]):
        ...
        for iteration in range(iters):
            ...
            points_np = point_coords.cpu().numpy()[0]  # (num_points, 2)
            labels_np = point_labels.cpu().numpy()[0]  # (num_points,)
