#!/usr/bin/env python3
"""Process generated person images with SAM."""
import os
import argparse
import numpy as np
...
def process_images(image_dir, output_dir, checkpoint, iters=5):
    """Process all images in directory with SAM."""
    ...
    for i, filename in enumerate(image_files):
        ...
        try:
            refined, ious, _ = sam_refiner(
                image_path, [init_mask], sam, iters=iters
            )
...
def main():
    ...
    parser.add_argument("--output_dir", default="output/sam1")
