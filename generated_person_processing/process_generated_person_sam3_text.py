#!/usr/bin/env python3
"""Process generated person images with SAM3 text grounding."""
import os
import argparse
import numpy as np
...
def process_images(image_dir, output_dir, checkpoint, text_prompt="person", iters=3):
    """Process all images in directory with SAM3 text grounding."""
...
def main():
    ...
    parser.add_argument("--output_dir", default="output/sam3_text")
