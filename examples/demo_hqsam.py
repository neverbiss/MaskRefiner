...
def main():
    ...
    parser.add_argument("--checkpoint", required=True, help="HQ-SAM checkpoint path")
    ...
    parser.add_argument("--output", default="refined_mask_hqsam.png")
    ...
    refined, ious, _ = sam_refiner(
        args.image, [init_mask], sam, iters=args.iters, use_samhq=True
    )
